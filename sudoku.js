...
Sudoku.prototype.drawBoard = function(){
    ...
    var sudoku_gameover = $('<div class="gameover_container"></div>')
                                .addClass('gameover')
    .html('</span> <b>Score Added:</b> <span class="gameover">' +score + '</span>');
...
Sudoku.prototype.resizeWindow = function(){
    ...
    $('#'+ this.id +' .gameover').css({'center': gameover_pos_new.center, 'top': gameover_pos_new.top});    
...
function sudokuscoredata(){
    sudokudbscore=h;
    console.log(sudokudbscore);
    var name=localStorage.getItem(1);
    console.log("===",name);
    var request = new XMLHttpRequest();
    request.open('POST', 'http://localhost:8080/MINI/rest/hello/sudokuscore', true);
    request.setRequestHeader("Content-Type","application/json"); 
    var body= '{"sudokudbscore":"'+sudokudbscore+'", "userName":"'+name+'"}';
